/**
 * Premium SVG channel icons — replaces cheap emoji icons everywhere.
 * Each icon matches the real brand identity at 16x16 or scalable.
 */
  ...
  switch (channel) {
    ...
    case "referral":
      return (
        <svg width={s} height={s} viewBox="0 0 16 16" fill="none" className={className}>
          <path
            d="M8 2L9.55 5.47L13.5 5.82L10.5 8.47L11.45 12.5L8 10.35L4.55 12.5L5.5 8.47L2.5 5.82L6.45 5.47L8 2Z"
...
/** Returns the brand color for each channel */
